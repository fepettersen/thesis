...
These experiments have been done using the BE discretization so that simulations can be done for a longer time and still show the effects to their full extent. 
