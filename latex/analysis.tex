...
\begin{figure}[H]
 ...
 \caption[Numerical errors illustration]{Illustration of how numerical errors appear. The dashed line shows the numerical integration of the equation $\frac{du}{dt} = -e^{-t}$ calculated with $6$ points, while the full line is the exact solution $u(t)= e^{-t}$. The numerical scheme approximates the derivative as a constant between two points, an approximation which will become increasingly good as the resolution improves. }
