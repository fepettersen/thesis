...
These experiments have been done using the Backward Euler discretization so that simulate can be done for a longer time and still show the effects to their full extent. 
