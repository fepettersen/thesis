...
The convergence test shown in Figure \ref{ConvergenceTestRW:Hc} suggests that the convergence rate for random walks follows the proportionality in equation \eqref{convergence_rate_RW}. 
