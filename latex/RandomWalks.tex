...
\begin{equation}
 P(x,t) = \frac{1}{2a}\sqrt{\frac{2\tau}{\pi t}}e^{-\frac{x^2\tau}{2a^2t}}.
\end{equation}
...
\begin{equation}
 P(x,t) = \sqrt{\frac{1}{4\pi Dt}}e^{-\frac{x^2}{4Dt}}
\end{equation}
...
\begin{equation}
 P(x,N)\propto e^{-\frac{x^2}{2M\sigma^2}}
\end{equation}
Seeing as $M\propto t$ we can introduce an Einstein relation and substitute $2M\sigma^2\to4Dt$. 
