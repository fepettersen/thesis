This chapter will concern the theory needed to implement a hybrid diffusion solver using Random Walks as a lower scale model. 
Random Walk is a Monte Carlo (MC\nomenclature{MC}{Monte Carlo}) method, which is a large group of algorithms that use random sampling to achieve numerical results. 
